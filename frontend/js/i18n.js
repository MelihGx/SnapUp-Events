(() => {
  ...
  const termsParagraphs = {
    "Terms of Use — SnapUp Events": p("Kullanım Koşulları — SnapUp Events", "شروط الاستخدام — SnapUp Events"),
    "Read the rules that apply when you create, join, or share content through SnapUp Events.": p("SnapUp Events üzerinden etkinlik oluştururken, etkinliğe katılırken veya içerik paylaşırken geçerli olan kuralları oku.", "اقرأ القواعد المطبقة عند إنشاء فعالية أو الانضمام إليها أو مشاركة محتوى عبر SnapUp Events."),
    ...
    "Legal & service rules": p("Hukuk ve hizmet kuralları", "القواعد القانونية وقواعد الخدمة"),
    "These terms explain the rules for creating events, joining shared galleries, uploading memories, and using SnapUp Events responsibly.": p("Bu koşullar; etkinlik oluşturma, ortak galerilere katılma, anı yükleme ve SnapUp Events’i sorumlu biçimde kullanma kurallarını açıklar.", "توضح هذه الشروط قواعد إنشاء الفعاليات والانضمام إلى المعارض المشتركة ورفع الذكريات واستخدام SnapUp Events بمسؤولية."),
    ...
    "Events and access codes": p("Etkinlikler ve erişim kodları", "الفعاليات ورموز الوصول"),
    "Your content and permissions": p("İçeriğin ve izinler", "محتواك والأذونات"),
    "Organizer responsibilities": p("Organizatör sorumlulukları", "مسؤوليات المنظم"),
    "Acceptable use": p("Kabul edilebilir kullanım", "الاستخدام المقبول"),
    "Moderation and reports": p("Moderasyon ve bildirimler", "الإشراف والبلاغات"),
    "SnapUp ownership": p("SnapUp mülkiyeti", "ملكية SnapUp"),
    "Service changes and availability": p("Hizmet değişiklikleri ve kullanılabilirlik", "تغييرات الخدمة وتوافرها"),
    "Fees and future paid features": p("Ücretler ve gelecekteki ücretli özellikler", "الرسوم والميزات المدفوعة مستقبلًا"),
    "Suspension and termination": p("Askıya alma ve sona erdirme", "التعليق والإنهاء"),
    "Disclaimers and liability": p("Sorumluluk reddi ve yükümlülük", "إخلاء المسؤولية وحدودها"),
    "Governing law and disputes": p("Uygulanacak hukuk ve uyuşmazlıklar", "القانون الحاكم والنزاعات"),
    "Changes to these terms": p("Bu koşullardaki değişiklikler", "التغييرات على هذه الشروط"),
    "Before publishing these terms, complete the legal name, address, contact email, governing-law, dispute, age, and liability fields. Confirm that the final text matches the countries where SnapUp Events will be offered and obtain professional legal review.": p("Bu koşulları yayımlamadan önce yasal ad, adres, iletişim e-postası, uygulanacak hukuk, uyuşmazlık, yaş ve sorumluluk alanlarını doldur. Son metnin SnapUp Events’in sunulacağı ülkelerle uyumlu olduğunu doğrula ve profesyonel hukuk incelemesi al.", "قبل نشر هذه الشروط، أكمل حقول الاسم القانوني والعنوان وبريد التواصل والقانون الحاكم والنزاعات والعمر والمسؤولية. تأكد من ملاءمة النص النهائي للبلدان التي ستُقدَّم فيها SnapUp Events واحصل على مراجعة قانونية متخصصة."),
    "SnapUp Events gives organizers and guests a shared place for event photos, videos, and messages. Use the Service lawfully, protect private event codes, upload only content you are allowed to share, and respect the people shown or heard in that content.": p("SnapUp Events, organizatörlere ve misafirlere etkinlik fotoğrafları, videoları ve mesajları için ortak bir alan sunar. Hizmeti hukuka uygun kullan, özel etkinlik kodlarını koru, yalnızca paylaşma iznin olan içerikleri yükle ve içerikte görünen ya da duyulan kişilere saygı göster.", "تمنح SnapUp Events المنظمين والضيوف مساحة مشتركة لصور الفعالية وفيديوهاتها ورسائلها. استخدم الخدمة بصورة قانونية واحمِ رموز الفعاليات الخاصة ولا ترفع إلا المحتوى المسموح لك بمشاركته واحترم الأشخاص الظاهرين أو المسموعين فيه."),
    "Keep access codes private": p("Erişim kodlarını gizli tut", "حافظ على خصوصية رموز الوصول"),
    "Anyone with an event code may be able to reach that event. Share codes only with the intended participants.": p("Etkinlik koduna sahip olan herkes etkinliğe erişebilir. Kodları yalnızca hedeflenen katılımcılarla paylaş.", "قد يتمكن أي شخص يملك رمز الفعالية من الوصول إليها. شارك الرموز فقط مع المشاركين المقصودين."),
    "Share only permitted content": p("Yalnızca izinli içerik paylaş", "شارك المحتوى المسموح فقط"),
    "You must have the rights and permissions needed for every photo, video, message, or other item you upload.": p("Yüklediğin her fotoğraf, video, mesaj veya diğer öğe için gerekli hak ve izinlere sahip olmalısın.", "يجب أن تملك الحقوق والأذونات اللازمة لكل صورة أو فيديو أو رسالة أو عنصر آخر ترفعه."),
    "Organizers manage their events": p("Organizatörler etkinliklerini yönetir", "يدير المنظمون فعالياتهم"),
    "Organizers choose access, moderation, visibility, and upload settings and are responsible for using them appropriately.": p("Organizatörler erişim, moderasyon, görünürlük ve yükleme ayarlarını seçer ve bunları uygun biçimde kullanmaktan sorumludur.", "يختار المنظمون إعدادات الوصول والإشراف والظهور والرفع ويتحملون مسؤولية استخدامها بصورة مناسبة."),
    "Unsafe use may be restricted": p("Güvensiz kullanım kısıtlanabilir", "قد يُقيَّد الاستخدام غير الآمن"),
    "We may remove content or limit access when reasonably needed to protect people, rights, security, or the Service.": p("İnsanları, hakları, güvenliği veya Hizmeti korumak için makul ölçüde gerektiğinde içeriği kaldırabilir ya da erişimi sınırlayabiliriz.", "قد نزيل المحتوى أو نقيّد الوصول عند الحاجة المعقولة لحماية الأشخاص أو الحقوق أو الأمان أو الخدمة."),
    "These Terms of Use form an agreement between you and [LEGAL NAME — TO BE COMPLETED] for your access to the SnapUp Events website, accounts, event creation tools, guest upload flow, galleries, and related features (the “Service”).": p("Bu Kullanım Koşulları, SnapUp Events internet sitesine, hesaplara, etkinlik oluşturma araçlarına, misafir yükleme akışına, galerilere ve ilgili özelliklere (birlikte “Hizmet”) erişimin için seninle [YASAL AD — DOLDURULACAK] arasında bir sözleşme oluşturur.", "تشكل شروط الاستخدام هذه اتفاقًا بينك وبين [الاسم القانوني — يُستكمل] بشأن وصولك إلى موقع SnapUp Events والحسابات وأدوات إنشاء الفعاليات ومسار رفع الضيوف والمعارض والميزات المرتبطة بها («الخدمة»)."),
    "By creating an account, creating or joining an event, uploading content, or otherwise using the Service, you agree to these terms and acknowledge the Privacy Policy. If you do not agree, do not use the Service. Event organizers may set additional event rules, but those rules cannot override these terms or applicable law.": p("Bir hesap oluşturarak, etkinlik oluşturarak veya etkinliğe katılarak, içerik yükleyerek ya da Hizmeti başka biçimde kullanarak bu koşulları kabul eder ve Gizlilik Politikasını okuduğunu beyan edersin. Kabul etmiyorsan Hizmeti kullanma. Organizatörler ek etkinlik kuralları belirleyebilir; ancak bu kurallar bu koşulların veya geçerli hukukun önüne geçemez.", "بإنشاء حساب أو فعالية أو الانضمام إليها أو رفع محتوى أو استخدام الخدمة بأي طريقة أخرى فإنك توافق على هذه الشروط وتقر بسياسة الخصوصية. إذا لم توافق فلا تستخدم الخدمة. يجوز للمنظمين وضع قواعد إضافية للفعالية، لكنها لا تتجاوز هذه الشروط أو القانون المطبق."),
    "You must be legally able to enter into this agreement in your country. The minimum age for independent use is [MINIMUM AGE — TO BE COMPLETED]. A child who cannot lawfully consent must use the Service only with the involvement and permission of a parent, guardian, or otherwise authorized adult.": p("Bulunduğun ülkede bu sözleşmeyi yapmaya hukuken ehil olmalısın. Bağımsız kullanım için asgari yaş [ASGARİ YAŞ — DOLDURULACAK]’tır. Hukuken onay veremeyen bir çocuk Hizmeti yalnızca ebeveyninin, vasisinin veya yetkili başka bir yetişkinin katılımı ve izniyle kullanmalıdır.", "يجب أن تكون قادرًا قانونيًا على إبرام هذا الاتفاق في بلدك. الحد الأدنى للعمر للاستخدام المستقل هو [الحد الأدنى للعمر — يُستكمل]. على الطفل الذي لا يستطيع الموافقة قانونيًا استخدام الخدمة فقط بمشاركة وإذن أحد الوالدين أو الوصي أو شخص بالغ مخول."),
    "Give accurate account information, keep it current, protect your password and login token, and notify us if you suspect unauthorized access. You are responsible for activity performed through your account unless applicable law provides otherwise. Do not sell, transfer, or share an account in a way that compromises security or identity.": p("Doğru hesap bilgileri ver, bilgilerini güncel tut, şifreni ve giriş belirtecini koru ve yetkisiz erişimden şüphelenirsen bize bildir. Geçerli hukuk aksini öngörmedikçe hesabın üzerinden gerçekleştirilen faaliyetlerden sen sorumlusun. Hesabı güvenliği veya kimliği tehlikeye atacak biçimde satma, devretme ya da paylaşma.", "قدّم معلومات حساب صحيحة وحافظ على تحديثها واحمِ كلمة المرور ورمز الدخول وأبلغنا إذا اشتبهت في وصول غير مصرح به. أنت مسؤول عن النشاط المنفذ عبر حسابك ما لم ينص القانون على خلاف ذلك. لا تبع الحساب أو تنقله أو تشاركه بطريقة تعرّض الأمان أو الهوية للخطر."),
    "Organizers can create event spaces and control settings such as guest uploads, approvals, comments, likes, and gallery visibility. An event code is a sharing mechanism, not a high-security password. The organizer must distribute the code carefully and choose settings suitable for the event and its participants.": p("Organizatörler etkinlik alanları oluşturabilir ve misafir yüklemeleri, onaylar, yorumlar, beğeniler ve galeri görünürlüğü gibi ayarları yönetebilir. Etkinlik kodu bir paylaşım aracıdır; yüksek güvenlikli bir şifre değildir. Organizatör kodu dikkatle dağıtmalı ve etkinliğe ve katılımcılara uygun ayarları seçmelidir.", "يمكن للمنظمين إنشاء مساحات للفعاليات والتحكم في إعدادات مثل رفع الضيوف والموافقات والتعليقات والإعجابات وظهور المعرض. رمز الفعالية وسيلة مشاركة وليس كلمة مرور عالية الأمان. يجب على المنظم توزيعه بعناية واختيار إعدادات مناسبة للفعالية ومشاركيها."),
    "An event code can be forwarded.": p("Etkinlik kodu başkasına iletilebilir.", "يمكن إعادة توجيه رمز الفعالية."),
    "Do not place a private code in a public post or public webpage. If a code is exposed, the organizer should restrict the event and contact support when necessary.": p("Özel bir kodu herkese açık bir gönderide veya internet sayfasında paylaşma. Kod açığa çıkarsa organizatör etkinliği kısıtlamalı ve gerektiğinde destekle iletişime geçmelidir.", "لا تضع رمزًا خاصًا في منشور أو صفحة عامة. إذا انكشف الرمز فعلى المنظم تقييد الفعالية والتواصل مع الدعم عند الحاجة."),
    "You keep ownership of photos, videos, messages, captions, and other material you upload (“User Content”). You grant SnapUp Events a limited, non-exclusive, worldwide license to host, store, copy, process, resize, transcode, display, and transmit User Content only as reasonably necessary to operate, secure, and improve the Service and provide the event experience you request.": p("Yüklediğin fotoğraf, video, mesaj, açıklama ve diğer materyallerin (“Kullanıcı İçeriği”) mülkiyeti sende kalır. SnapUp Events’e Kullanıcı İçeriğini yalnızca Hizmeti işletmek, güvenceye almak, geliştirmek ve talep ettiğin etkinlik deneyimini sunmak için makul ölçüde gerektiği kadar barındırma, saklama, kopyalama, işleme, yeniden boyutlandırma, kod dönüştürme, görüntüleme ve iletme konusunda sınırlı, münhasır olmayan ve dünya çapında bir lisans verirsin.", "تحتفظ بملكية الصور والفيديوهات والرسائل والتعليقات والمواد الأخرى التي ترفعها («محتوى المستخدم»). وتمنح SnapUp Events ترخيصًا محدودًا وغير حصري وعالميًا لاستضافة محتوى المستخدم وتخزينه ونسخه ومعالجته وتغيير حجمه وتحويل ترميزه وعرضه ونقله فقط بالقدر المعقول لتشغيل الخدمة وتأمينها وتحسينها وتقديم تجربة الفعالية المطلوبة."),
    "You confirm that you have all rights, notices, consents, and permissions needed to upload and share the content, including permission relating to people shown or heard in it. The license ends when the content is deleted from active systems, subject to reasonable backup, security, and legal-retention periods.": p("İçeriği yüklemek ve paylaşmak için, içerikte görünen veya duyulan kişilerle ilgili izinler dâhil olmak üzere gerekli tüm haklara, bildirimlere, rızalara ve izinlere sahip olduğunu doğrularsın. Lisans; makul yedekleme, güvenlik ve yasal saklama süreleri saklı kalmak üzere içerik aktif sistemlerden silindiğinde sona erer.", "تؤكد امتلاك جميع الحقوق والإشعارات والموافقات والأذونات اللازمة لرفع المحتوى ومشاركته، بما في ذلك ما يتعلق بالأشخاص الظاهرين أو المسموعين فيه. ينتهي الترخيص عند حذف المحتوى من الأنظمة النشطة مع مراعاة فترات النسخ الاحتياطي والأمان والاحتفاظ القانوني المعقولة."),
    "An organizer decides why an event exists, who receives access, what participants may upload, whether content requires approval, and whether a gallery is restricted or shareable. Organizers must give any legally required notices, obtain permissions, moderate the event appropriately, handle participant requests, and avoid public sharing when the event requires privacy.": p("Bir etkinliğin neden oluşturulduğuna, kimlerin erişim alacağına, katılımcıların ne yükleyebileceğine, içeriğin onay gerektirip gerektirmediğine ve galerinin kısıtlı mı paylaşılabilir mi olacağına organizatör karar verir. Organizatörler gerekli hukuki bildirimleri yapmalı, izinleri almalı, etkinliği uygun biçimde denetlemeli, katılımcı taleplerini ele almalı ve etkinlik gizlilik gerektiriyorsa herkese açık paylaşımdan kaçınmalıdır.", "يقرر المنظم سبب إنشاء الفعالية ومن يحصل على الوصول وما يمكن للمشاركين رفعه وما إذا كان المحتوى يحتاج إلى موافقة وما إذا كان المعرض مقيّدًا أو قابلًا للمشاركة. يجب على المنظمين تقديم الإشعارات القانونية والحصول على الأذونات والإشراف المناسب ومعالجة طلبات المشاركين وتجنب المشاركة العامة عند الحاجة إلى الخصوصية."),
    "You must not use the Service to:": p("Hizmeti şu amaçlarla kullanmamalısın:", "يجب ألا تستخدم الخدمة من أجل:"),
    "Upload or share unlawful, abusive, threatening, hateful, exploitative, sexually abusive, or seriously harmful content.": p("Hukuka aykırı, taciz edici, tehditkâr, nefret içeren, sömürücü, cinsel istismar içeren veya ciddi biçimde zararlı içerik yüklemek ya da paylaşmak.", "رفع أو مشاركة محتوى غير قانوني أو مسيء أو مهدد أو كاره أو استغلالي أو يتضمن إساءة جنسية أو ضررًا جسيمًا."),
    "Violate privacy, publicity, copyright, trademark, confidentiality, or other rights.": p("Gizlilik, kişilik, telif, marka, sır saklama veya diğer hakları ihlal etmek.", "انتهاك الخصوصية أو حقوق الصورة أو حقوق النشر أو العلامات التجارية أو السرية أو غيرها من الحقوق."),
    "Impersonate another person, mislead participants, conduct fraud, phishing, spam, or unauthorized commercial promotion.": p("Başka biri gibi davranmak, katılımcıları yanıltmak, dolandırıcılık, oltalama, istenmeyen ileti veya izinsiz ticari tanıtım yapmak.", "انتحال شخصية أخرى أو تضليل المشاركين أو تنفيذ احتيال أو تصيد أو رسائل مزعجة أو ترويج تجاري غير مصرح به."),
    "Upload malware, attempt to bypass access controls, probe vulnerabilities, overload the Service, or disrupt other users.": p("Zararlı yazılım yüklemek, erişim kontrollerini aşmaya çalışmak, açık taramak, Hizmeti aşırı yüklemek veya diğer kullanıcıları engellemek.", "رفع برمجيات ضارة أو محاولة تجاوز ضوابط الوصول أو فحص الثغرات أو إثقال الخدمة أو تعطيل المستخدمين الآخرين."),
    "Scrape, harvest, or collect account, guest, event, or media data without lawful authority and permission.": p("Hukuki yetki ve izin olmadan hesap, misafir, etkinlik veya medya verilerini kazımak, toplamak ya da derlemek.", "استخراج أو جمع بيانات الحسابات أو الضيوف أو الفعاليات أو الوسائط دون سلطة قانونية وإذن."),
    "Use the Service for surveillance, facial recognition, biometric identification, or other high-risk profiling without an independent lawful basis and our written authorization.": p("Bağımsız bir hukuki dayanak ve yazılı iznimiz olmadan Hizmeti gözetim, yüz tanıma, biyometrik tanımlama veya başka yüksek riskli profilleme amacıyla kullanmak.", "استخدام الخدمة للمراقبة أو التعرف على الوجه أو الهوية البيومترية أو أي تنميط عالي المخاطر دون أساس قانوني مستقل وإذننا الكتابي."),
    "Moderation, removal, and reports": p("Moderasyon, kaldırma ve bildirimler", "الإشراف والإزالة والبلاغات"),
    "Organizers may approve, reject, hide, or delete content in their events. We may investigate reports and remove content, restrict an event, preserve evidence, or limit an account when reasonably necessary to enforce these terms, comply with law, respond to valid rights claims, or protect users and platform security. Moderation tools do not guarantee that every inappropriate item will be detected before it appears.": p("Organizatörler etkinliklerindeki içerikleri onaylayabilir, reddedebilir, gizleyebilir veya silebilir. Bu koşulları uygulamak, hukuka uymak, geçerli hak taleplerini yanıtlamak ya da kullanıcıları ve platform güvenliğini korumak için makul ölçüde gerektiğinde bildirimleri inceleyebilir; içeriği kaldırabilir, etkinliği kısıtlayabilir, delilleri koruyabilir veya hesabı sınırlayabiliriz. Moderasyon araçları her uygunsuz öğenin görünmeden önce tespit edileceğini garanti etmez.", "يجوز للمنظمين الموافقة على المحتوى أو رفضه أو إخفاؤه أو حذفه. وقد نحقق في البلاغات ونزيل المحتوى أو نقيّد فعالية أو نحفظ الأدلة أو نحد من حساب عند الحاجة المعقولة لإنفاذ الشروط أو الامتثال للقانون أو الاستجابة لمطالبات حقوق صحيحة أو حماية المستخدمين وأمان المنصة. لا تضمن أدوات الإشراف اكتشاف كل عنصر غير مناسب قبل ظهوره."),
    "The Service, including its software, design, branding, interface, documentation, and platform-generated materials, belongs to SnapUp Events or its licensors and is protected by applicable intellectual-property law. These terms give you a limited, revocable, non-transferable right to use the Service for its intended purpose; they do not transfer ownership of the platform or the SnapUp name and marks.": p("Yazılımı, tasarımı, markası, arayüzü, belgeleri ve platform tarafından oluşturulan materyalleri dâhil Hizmet, SnapUp Events’e veya lisans verenlerine aittir ve geçerli fikrî mülkiyet hukukuyla korunur. Bu koşullar sana Hizmeti amacı doğrultusunda kullanmak için sınırlı, geri alınabilir ve devredilemez bir hak verir; platformun veya SnapUp adı ve markalarının mülkiyetini devretmez.", "تعود الخدمة بما فيها البرمجيات والتصميم والعلامة والواجهة والوثائق والمواد المنشأة بواسطة المنصة إلى SnapUp Events أو مرخصيها وتحميها قوانين الملكية الفكرية. تمنحك الشروط حقًا محدودًا وقابلًا للإلغاء وغير قابل للنقل لاستخدام الخدمة لغرضها ولا تنقل ملكية المنصة أو اسم وعلامات SnapUp."),
    "SnapUp Events is under active development. Features, limits, packages, storage, supported formats, and interfaces may change. We aim to operate the Service reliably but cannot promise uninterrupted or error-free access. Maintenance, security events, provider failures, legal requirements, or circumstances outside our control may cause delay, interruption, or data unavailability. Keep independent copies of important event media.": p("SnapUp Events aktif olarak geliştirilmektedir. Özellikler, sınırlar, paketler, depolama, desteklenen biçimler ve arayüzler değişebilir. Hizmeti güvenilir biçimde çalıştırmayı amaçlarız; ancak kesintisiz veya hatasız erişim sözü veremeyiz. Bakım, güvenlik olayları, sağlayıcı arızaları, hukuki gereklilikler veya kontrolümüz dışındaki durumlar gecikmeye, kesintiye ya da verilerin kullanılamamasına yol açabilir. Önemli etkinlik medyasının bağımsız kopyalarını sakla.", "تخضع SnapUp Events لتطوير نشط وقد تتغير الميزات والحدود والباقات والتخزين والصيغ المدعومة والواجهات. نهدف إلى تشغيل الخدمة بموثوقية لكن لا نضمن وصولًا بلا انقطاع أو أخطاء. قد تؤدي الصيانة أو حوادث الأمان أو أعطال المزودين أو المتطلبات القانونية أو الظروف الخارجة عن سيطرتنا إلى تأخير أو انقطاع أو عدم توافر البيانات. احتفظ بنسخ مستقلة من وسائط الفعالية المهمة."),
    "The current pre-launch or demonstration experience may include package names, price examples, or simulated payment screens that do not create a real purchase. If paid features are introduced, the price, taxes, payment timing, renewal terms, refund rules, and any additional purchase terms will be shown before you authorize a charge. We will not convert a free or demonstration flow into a paid purchase without clear notice and your action.": p("Mevcut yayın öncesi veya demo deneyimi, gerçek bir satın alma oluşturmayan paket adları, fiyat örnekleri ya da simüle edilmiş ödeme ekranları içerebilir. Ücretli özellikler eklenirse fiyat, vergiler, ödeme zamanı, yenileme koşulları, iade kuralları ve ek satın alma koşulları bir ödemeye onay vermenden önce gösterilecektir. Açık bildirim ve senin işlemin olmadan ücretsiz veya demo bir akışı ücretli satın almaya dönüştürmeyiz.", "قد تتضمن تجربة ما قبل الإطلاق أو العرض أسماء باقات أو أمثلة أسعار أو شاشات دفع محاكاة لا تنشئ عملية شراء حقيقية. إذا أُضيفت ميزات مدفوعة فسيُعرض السعر والضرائب وتوقيت الدفع وشروط التجديد وقواعد الاسترداد وأي شروط شراء إضافية قبل أن توافق على الرسوم. لن نحول مسارًا مجانيًا أو تجريبيًا إلى شراء مدفوع دون إشعار واضح وإجراء منك."),
    "You may stop using the Service at any time and may request account or event deletion through the available controls or contact channel. We may suspend or terminate access for a serious or repeated breach, security risk, unlawful use, non-payment of a future paid feature, or when operation is no longer reasonably possible. Where appropriate, we will give notice and an opportunity to export content before termination.": p("Hizmeti istediğin zaman kullanmayı bırakabilir ve mevcut kontroller veya iletişim kanalı üzerinden hesap ya da etkinlik silme talebinde bulunabilirsin. Ciddi veya tekrarlanan ihlal, güvenlik riski, hukuka aykırı kullanım, gelecekteki ücretli bir özelliğin ödenmemesi veya işletimin artık makul biçimde mümkün olmaması hâlinde erişimi askıya alabilir ya da sona erdirebiliriz. Uygun olduğunda sona erdirmeden önce bildirim ve içerik dışa aktarma imkânı sunarız.", "يمكنك التوقف عن استخدام الخدمة في أي وقت وطلب حذف الحساب أو الفعالية عبر الأدوات أو قناة التواصل. قد نعلّق أو ننهي الوصول بسبب خرق جسيم أو متكرر أو خطر أمني أو استخدام غير قانوني أو عدم دفع ميزة مدفوعة مستقبلًا أو عندما يصبح التشغيل غير ممكن بصورة معقولة. عند الملاءمة سنقدم إشعارًا وفرصة لتصدير المحتوى قبل الإنهاء."),
    "Disclaimers and limitation of liability": p("Sorumluluk reddi ve sorumluluğun sınırı", "إخلاء المسؤولية وتحديدها"),
    "To the extent permitted by law, the Service is provided “as is” and “as available.” We do not control the accuracy, legality, quality, or conduct associated with User Content or event participants. Organizers and uploaders remain responsible for their decisions, content, permissions, and independent backups.": p("Hukukun izin verdiği ölçüde Hizmet “olduğu gibi” ve “mevcut olduğu ölçüde” sunulur. Kullanıcı İçeriğinin veya etkinlik katılımcılarının doğruluğunu, hukuka uygunluğunu, kalitesini ya da davranışlarını kontrol etmeyiz. Organizatörler ve yükleyenler kararlarından, içeriklerinden, izinlerinden ve bağımsız yedeklerinden sorumlu olmaya devam eder.", "تُقدَّم الخدمة «كما هي» و«حسب التوافر» بالقدر الذي يسمح به القانون. لا نتحكم في دقة أو قانونية أو جودة محتوى المستخدم أو سلوك المشاركين. يظل المنظمون والرافعون مسؤولين عن قراراتهم ومحتواهم وأذوناتهم ونسخهم الاحتياطية المستقلة."),
    "Nothing in these terms excludes rights or liability that cannot lawfully be excluded. Subject to that rule, any liability cap, excluded loss categories, and country-specific consumer rights must be completed before launch: [LIABILITY TERMS — TO BE COMPLETED].": p("Bu koşullardaki hiçbir hüküm hukuken hariç tutulamayacak hakları veya sorumluluğu ortadan kaldırmaz. Bu kural saklı kalmak üzere sorumluluk üst sınırı, hariç tutulan zarar kategorileri ve ülkeye özgü tüketici hakları yayından önce tamamlanmalıdır: [SORUMLULUK KOŞULLARI — DOLDURULACAK].", "لا تستبعد هذه الشروط حقوقًا أو مسؤوليات لا يجوز قانونًا استبعادها. مع مراعاة ذلك، يجب قبل الإطلاق إكمال حد المسؤولية وفئات الخسائر المستبعدة وحقوق المستهلك الخاصة بكل بلد: [شروط المسؤولية — تُستكمل]."),
    "These terms are governed by [GOVERNING LAW — TO BE COMPLETED]. Courts or dispute-resolution bodies located in [VENUE — TO BE COMPLETED] will have jurisdiction, except where mandatory consumer law gives you the right to bring a claim elsewhere. Before starting formal proceedings, you and SnapUp Events should try in good faith to resolve the issue through the contact details below.": p("Bu koşullara [UYGULANACAK HUKUK — DOLDURULACAK] uygulanır. Zorunlu tüketici hukuku sana başka yerde talepte bulunma hakkı vermedikçe [YETKİLİ YER — DOLDURULACAK] konumundaki mahkemeler veya uyuşmazlık çözüm mercileri yetkilidir. Resmî sürece başlamadan önce sen ve SnapUp Events aşağıdaki iletişim bilgileri üzerinden sorunu iyi niyetle çözmeye çalışmalısınız.", "تخضع هذه الشروط لـ[القانون الحاكم — يُستكمل]. تختص المحاكم أو هيئات تسوية النزاعات في [المكان — يُستكمل] ما لم يمنحك قانون المستهلك الإلزامي حق رفع مطالبة في مكان آخر. قبل بدء إجراءات رسمية ينبغي لك ولـSnapUp Events محاولة حل المشكلة بحسن نية عبر بيانات التواصل أدناه."),
    "Changes to these Terms of Use": p("Bu Kullanım Koşullarındaki değişiklikler", "التغييرات على شروط الاستخدام"),
    "We may update these terms when the Service, business model, risk, providers, or law changes. The date and version above identify the current terms. If a change materially affects existing users, we will provide reasonable additional notice before it takes effect where required. Continued use after the effective date means the updated terms apply, subject to mandatory law.": p("Hizmet, iş modeli, riskler, sağlayıcılar veya hukuk değiştiğinde bu koşulları güncelleyebiliriz. Yukarıdaki tarih ve sürüm mevcut koşulları gösterir. Bir değişiklik mevcut kullanıcıları önemli ölçüde etkilerse gerektiğinde yürürlüğe girmeden önce makul ek bildirim sağlarız. Yürürlük tarihinden sonra kullanıma devam etmek, zorunlu hukuk saklı kalmak üzere güncellenen koşulların uygulanacağı anlamına gelir.", "قد نحدّث هذه الشروط عند تغير الخدمة أو نموذج الأعمال أو المخاطر أو المزودين أو القانون. يحدد التاريخ والإصدار أعلاه الشروط الحالية. إذا أثر التغيير جوهريًا على المستخدمين الحاليين فسنقدم إشعارًا إضافيًا معقولًا قبل نفاذه حيث يلزم. استمرار الاستخدام بعد تاريخ السريان يعني تطبيق الشروط المحدثة مع مراعاة القانون الإلزامي."),
    "Questions, reports, rights notices, or concerns about these terms can be sent using the details below. Include enough information to identify the relevant account, event, or content without sending passwords or unnecessary sensitive information.": p("Bu koşullarla ilgili soruları, bildirimleri, hak taleplerini veya endişeleri aşağıdaki bilgiler üzerinden gönderebilirsin. Şifre veya gereksiz hassas bilgi göndermeden ilgili hesabı, etkinliği ya da içeriği belirlemeye yetecek bilgi ekle.", "يمكن إرسال الأسئلة أو البلاغات أو إشعارات الحقوق أو المخاوف بشأن هذه الشروط عبر التفاصيل أدناه. أدرج معلومات كافية لتحديد الحساب أو الفعالية أو المحتوى دون إرسال كلمات مرور أو معلومات حساسة غير ضرورية."),
    "Service provider": p("Hizmet sağlayıcı", "مقدم الخدمة"),
    "Support email": p("Destek e-postası", "بريد الدعم"),
    "Related legal pages": p("İlgili hukuk sayfaları", "الصفحات القانونية ذات الصلة"),
    "Privacy Policy →": p("Gizlilik Politikası →", "سياسة الخصوصية ←")
  };
  ...
  const europeanPhrases = {
    ...
    "Terms of Use — SnapUp Events": ["Nutzungsbedingungen — SnapUp Events", "Conditions d’utilisation — SnapUp Events", "Términos de uso — SnapUp Events", "Termini di utilizzo — SnapUp Events", "Gebruiksvoorwaarden — SnapUp Events"],
    "Skip to terms": ["Zu den Bedingungen springen", "Aller aux conditions", "Ir a los términos", "Vai ai termini", "Naar de voorwaarden"],
    "Your content": ["Deine Inhalte", "Votre contenu", "Tu contenido", "I tuoi contenuti", "Jouw inhoud"],
    "Use rules": ["Nutzungsregeln", "Règles d’utilisation", "Reglas de uso", "Regole d’uso", "Gebruiksregels"],
    "Legal & service rules": ["Recht & Serviceregeln", "Règles juridiques et du service", "Reglas legales y del servicio", "Regole legali e del servizio", "Juridische en serviceregels"],
    "Agreement and scope": ["Vereinbarung und Geltungsbereich", "Accord et champ d’application", "Acuerdo y alcance", "Accordo e ambito", "Overeenkomst en reikwijdte"],
    "Eligibility": ["Berechtigung", "Admissibilité", "Requisitos", "Idoneità", "Geschiktheid"],
    "Accounts and security": ["Konten und Sicherheit", "Comptes et sécurité", "Cuentas y seguridad", "Account e sicurezza", "Accounts en beveiliging"],
    "Events and access codes": ["Events und Zugangscodes", "Événements et codes d’accès", "Eventos y códigos de acceso", "Eventi e codici di accesso", "Evenementen en toegangscodes"],
    "Your content and permissions": ["Deine Inhalte und Berechtigungen", "Votre contenu et vos autorisations", "Tu contenido y permisos", "I tuoi contenuti e permessi", "Jouw inhoud en toestemmingen"],
    "Organizer responsibilities": ["Pflichten der Organisatoren", "Responsabilités de l’organisateur", "Responsabilidades del organizador", "Responsabilità dell’organizzatore", "Verantwoordelijkheden van de organisator"],
    "Acceptable use": ["Zulässige Nutzung", "Utilisation acceptable", "Uso aceptable", "Uso accettabile", "Aanvaardbaar gebruik"],
    "Moderation and reports": ["Moderation und Meldungen", "Modération et signalements", "Moderación e informes", "Moderazione e segnalazioni", "Moderatie en meldingen"],
    "SnapUp ownership": ["Eigentum von SnapUp", "Propriété de SnapUp", "Propiedad de SnapUp", "Proprietà di SnapUp", "Eigendom van SnapUp"],
    "Service changes and availability": ["Änderungen und Verfügbarkeit des Dienstes", "Modifications et disponibilité du service", "Cambios y disponibilidad del servicio", "Modifiche e disponibilità del servizio", "Wijzigingen en beschikbaarheid van de dienst"],
    "Fees and future paid features": ["Gebühren und künftige Bezahlfunktionen", "Frais et futures fonctionnalités payantes", "Tarifas y futuras funciones de pago", "Tariffe e future funzioni a pagamento", "Kosten en toekomstige betaalde functies"],
    "Suspension and termination": ["Sperrung und Beendigung", "Suspension et résiliation", "Suspensión y terminación", "Sospensione e cessazione", "Opschorting en beëindiging"],
    "Disclaimers and liability": ["Haftungsausschlüsse und Haftung", "Exclusions et responsabilité", "Exenciones y responsabilidad", "Esclusioni e responsabilità", "Disclaimers en aansprakelijkheid"],
    "Governing law and disputes": ["Anwendbares Recht und Streitigkeiten", "Droit applicable et litiges", "Ley aplicable y disputas", "Legge applicabile e controversie", "Toepasselijk recht en geschillen"],
    "Changes to these terms": ["Änderungen dieser Bedingungen", "Modifications de ces conditions", "Cambios en estos términos", "Modifiche a questi termini", "Wijzigingen in deze voorwaarden"],
    "Service provider": ["Dienstanbieter", "Prestataire de service", "Proveedor del servicio", "Fornitore del servizio", "Dienstverlener"],
    "Support email": ["Support-E-Mail", "E-mail d’assistance", "Correo de soporte", "E-mail di supporto", "Support-e-mail"],
    "JOIN EVENT": ["EVENT BEITRETEN", "REJOINDRE L’ÉVÉNEMENT", "UNIRSE AL EVENTO", "PARTECIPA ALL’EVENTO", "DEELNEMEN AAN EVENEMENT"],
  ...
  const balkanPhrases = {
    ...
    "Terms of Use — SnapUp Events": ["Условия за ползване — SnapUp Events", "Termeni de utilizare — SnapUp Events", "Όροι χρήσης — SnapUp Events", "Uslovi korišćenja — SnapUp Events", "Uvjeti korištenja — SnapUp Events", "Uslovi korištenja — SnapUp Events", "Kushtet e përdorimit — SnapUp Events", "Услови за користење — SnapUp Events"],
    "Skip to terms": ["Към условията", "Sari la termeni", "Μετάβαση στους όρους", "Pređi na uslove", "Prijeđi na uvjete", "Pređi na uslove", "Kalo te kushtet", "Премини на условите"],
    "Your content": ["Твоето съдържание", "Conținutul tău", "Το περιεχόμενό σου", "Tvoj sadržaj", "Tvoj sadržaj", "Tvoj sadržaj", "Përmbajtja jote", "Твојата содржина"],
    "Use rules": ["Правила за ползване", "Reguli de utilizare", "Κανόνες χρήσης", "Pravila korišćenja", "Pravila korištenja", "Pravila korištenja", "Rregullat e përdorimit", "Правила за користење"],
    "Legal & service rules": ["Правни правила и правила на услугата", "Reguli juridice și de serviciu", "Νομικοί κανόνες και κανόνες υπηρεσίας", "Pravna pravila i pravila usluge", "Pravna pravila i pravila usluge", "Pravna pravila i pravila usluge", "Rregullat ligjore dhe të shërbimit", "Правни правила и правила на услугата"],
    "Agreement and scope": ["Споразумение и обхват", "Acord și domeniu de aplicare", "Συμφωνία και πεδίο εφαρμογής", "Sporazum i obim", "Sporazum i opseg", "Sporazum i obim", "Marrëveshja dhe fushëveprimi", "Договор и опфат"],
    "Eligibility": ["Допустимост", "Eligibilitate", "Επιλεξιμότητα", "Uslovi za korišćenje", "Uvjeti korištenja", "Uslovi korištenja", "Kushtet e pranueshmërisë", "Подобност"],
    "Accounts and security": ["Профили и сигурност", "Conturi și securitate", "Λογαριασμοί και ασφάλεια", "Nalozi i bezbednost", "Računi i sigurnost", "Računi i sigurnost", "Llogaritë dhe siguria", "Сметки и безбедност"],
    "Events and access codes": ["Събития и кодове за достъп", "Evenimente și coduri de acces", "Εκδηλώσεις και κωδικοί πρόσβασης", "Događaji i pristupni kodovi", "Događaji i pristupni kodovi", "Događaji i pristupni kodovi", "Eventet dhe kodet e hyrjes", "Настани и кодови за пристап"],
    "Your content and permissions": ["Твоето съдържание и разрешения", "Conținutul și permisiunile tale", "Το περιεχόμενο και οι άδειές σου", "Tvoj sadržaj i dozvole", "Tvoj sadržaj i dopuštenja", "Tvoj sadržaj i dozvole", "Përmbajtja dhe lejet e tua", "Твојата содржина и дозволи"],
    "Organizer responsibilities": ["Отговорности на организатора", "Responsabilitățile organizatorului", "Ευθύνες διοργανωτή", "Odgovornosti organizatora", "Odgovornosti organizatora", "Odgovornosti organizatora", "Përgjegjësitë e organizatorit", "Одговорности на организаторот"],
    "Acceptable use": ["Допустима употреба", "Utilizare acceptabilă", "Αποδεκτή χρήση", "Prihvatljivo korišćenje", "Prihvatljivo korištenje", "Prihvatljivo korištenje", "Përdorimi i pranueshëm", "Прифатливо користење"],
    "Moderation and reports": ["Модериране и сигнали", "Moderare și raportări", "Εποπτεία και αναφορές", "Moderacija i prijave", "Moderiranje i prijave", "Moderacija i prijave", "Moderimi dhe raportimet", "Модерација и пријави"],
    "SnapUp ownership": ["Собственост на SnapUp", "Proprietatea SnapUp", "Ιδιοκτησία SnapUp", "Vlasništvo SnapUp-a", "Vlasništvo SnapUpa", "Vlasništvo SnapUp-a", "Pronësia e SnapUp", "Сопственост на SnapUp"],
    "Service changes and availability": ["Промени и наличност на услугата", "Modificări și disponibilitate", "Αλλαγές και διαθεσιμότητα υπηρεσίας", "Izmene i dostupnost usluge", "Promjene i dostupnost usluge", "Promjene i dostupnost usluge", "Ndryshimet dhe disponueshmëria", "Промени и достапност на услугата"],
    "Fees and future paid features": ["Такси и бъдещи платени функции", "Taxe și funcții plătite viitoare", "Χρεώσεις και μελλοντικές επί πληρωμή λειτουργίες", "Naknade i buduće plaćene funkcije", "Naknade i buduće plaćene značajke", "Naknade i buduće plaćene funkcije", "Tarifat dhe veçoritë e ardhshme me pagesë", "Надоместоци и идни платени функции"],
    "Suspension and termination": ["Спиране и прекратяване", "Suspendare și încetare", "Αναστολή και τερματισμός", "Suspenzija i raskid", "Obustava i raskid", "Suspenzija i raskid", "Pezullimi dhe përfundimi", "Суспензија и прекин"],
    "Disclaimers and liability": ["Откази и отговорност", "Declinări și răspundere", "Αποποιήσεις και ευθύνη", "Odricanja i odgovornost", "Odricanja i odgovornost", "Odricanja i odgovornost", "Mohimet dhe përgjegjësia", "Оградувања и одговорност"],
    "Governing law and disputes": ["Приложимо право и спорове", "Legea aplicabilă și litigii", "Εφαρμοστέο δίκαιο και διαφορές", "Merodavno pravo i sporovi", "Mjerodavno pravo i sporovi", "Mjerodavno pravo i sporovi", "Ligji zbatues dhe mosmarrëveshjet", "Меродавно право и спорови"],
    "Changes to these terms": ["Промени в тези условия", "Modificări ale acestor termeni", "Αλλαγές στους όρους", "Izmene ovih uslova", "Promjene ovih uvjeta", "Promjene ovih uslova", "Ndryshimet e këtyre kushteve", "Промени на овие услови"],
    "Service provider": ["Доставчик на услугата", "Furnizor de servicii", "Πάροχος υπηρεσίας", "Pružalac usluge", "Pružatelj usluge", "Pružalac usluge", "Ofruesi i shërbimit", "Давател на услугата"],
    "Support email": ["Имейл за поддръжка", "E-mail de asistență", "Email υποστήριξης", "Email podrške", "E-pošta podrške", "Email podrške", "Email-i i mbështetjes", "Е-пошта за поддршка"],
